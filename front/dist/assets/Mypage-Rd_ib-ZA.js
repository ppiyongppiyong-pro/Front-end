...
`,T=t.div`
  ...
  cursor: pointer;
  height: ${o=>o.height||"30px"};
`;function l({id:o,width:n,height:i,label:m,value:a=""}){const[r,p]=g.useState(!1),c=()=>{p(s=>!s)};return e.jsxs(N,{height:i,children:[e.jsx(E,{children:m}),e.jsxs(S,{width:n,height:i,children:[e.jsx(M,{id:o,type:"text",placeholder:"",height:i,readOnly:!r,value:a}),e.jsx(T,{onClick:c,height:i,children:e.jsx(B,{style:{width:15,height:15}})})]})]})}function Q(){const o=x(),[n,i]=g.useState({email:"",username:"",phoneNumber:"",gender:"",parentPhoneNumber:"",address:"",residentNo:""});g.useEffect(()=>{const a=localStorage.getItem("accessToken");if(!a){console.log("로그인이 필요합니다."),o("/");return}h.get("http://43.202.23.69:8080/api/v1/mypage/getProfile",{headers:{Authorization:`Bearer ${a}`}}).then(r=>{r&&r.data?i(r.data):console.error("서버에서 데이터를 정상적으로 불러오지 못했습니다.")}).catch(r=>{console.error("마이페이지 오류:",r),i({})})},[o]);const m=async()=>{var c;const a=localStorage.getItem("accessToken"),r=localStorage.getItem("email"),p=localStorage.getItem("password");if(!a){console.error("로그인 상태가 아닙니다."),o("/");return}try{(await h.post("http://43.202.23.69:8080/api/auth/logout",{email:r,password:p},{headers:{Authorization:`Bearer ${a}`,"Content-Type":"application/json"}})).data==="로그아웃 되었습니다."?(localStorage.removeItem("accessToken"),localStorage.removeItem("refreshToken"),localStorage.removeItem("email"),localStorage.removeItem("password"),console.log("로그아웃 성공!"),o("/")):console.error("로그아웃 실패: 서버에서 올바른 응답을 받지 못했습니다.")}catch(s){console.error("로그아웃 실패:",((c=s.response)==null?void 0:c.data)||s.message),alert("로그아웃을 실패했습니다. 다시 시도해주세요.")}};return e.jsx(f.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:e.jsxs(j,{children:[e.jsxs(w,{children:[e.jsxs(P,{children:[e.jsx("img",{className:"logo",src:y,alt:"logo"}),e.jsxs(z,{children:[e.jsx(A,{children:n.username}),e.jsx($,{onClick:m,children:e.jsx("img",{className:"logout",src:_,alt:"logout"})})]})]}),e.jsxs(b,{children:[e.jsxs(D,{children:[e.jsx(l,{id:"email",width:"310px",height:"35px",label:"아이디",value:n.email}),e.jsx(l,{id:"phoneNumber",width:"310px",height:"35px",label:"전화번호",value:n.phoneNumber}),e.jsx(l,{id:"parentPhoneNumber",width:"310px",height:"35px",label:"보호자 전화번호",value:n.parentPhoneNumber}),e.jsx(l,{id:"address",width:"310px",height:"35px",label:"주소",value:n.address}),e.jsx(l,{id:"residentNo",width:"310px",height:"35px",label:"주민등록번호",value:n.residentNo})]}),e.jsx(W,{children:e.jsx(H,{children:"회원탈퇴"})})]})]}),e.jsxs(V,{children:[e.jsx(O,{children:e.jsx("img",{src:v,width:"100%",alt:"footer_bar"})}),e.jsx(d,{src:k,alt:"map_icon",style:{marginLeft:"-10rem"},onClick:()=>o("/MapPage")}),e.jsx(d,{src:C,alt:"manual_icon",style:{marginLeft:"-6rem"},onClick:()=>o("/Manual")}),e.jsx(U,{src:F,alt:"logo_icon"}),e.jsx(d,{src:I,alt:"chat_icon",style:{marginLeft:"3.7rem"},onClick:()=>o("/Chat")}),e.jsx(d,{src:L,alt:"my_icon",style:{marginLeft:"8rem",marginTop:"-3.5rem"},onClick:()=>o("/Mypage")})]})]})})}const $=t.button`
  background: none;
  border: none;
  cursor: pointer;
`,P=t.header`
